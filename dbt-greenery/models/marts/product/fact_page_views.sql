...
select
    ...
    count(distinct case when e.event_type = 'add_to_cart' then event_id end) + count(distinct case when e.event_type = 'delete_from_cart' then event_id end) as net_added_to_cart,
    case 
